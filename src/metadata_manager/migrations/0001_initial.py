...
import metadata_manager.models.user
            ...
            fields=[
                (
                    ...
                    models.CharField(
                        ...
                        serialize=False,
                        unique=True,
                        validators=[metadata_manager.models.user.User.validate_israeli_id],
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=20,
                        validators=[metadata_manager.models.user.User.validate_phone],
                    ),
                ),
